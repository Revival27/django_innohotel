"""
Django settings for django_innohotel project.
...
SECRET_KEY = 'django-insecure-npa%@+@b%==y6^w$-3$8)gg8x*h_1^#^_!cz+b3l+t=6#n#jii'
...
WSGI_APPLICATION = 'django_innohotel.wsgi.application'
...
ROOT_URLCONF = 'django_innohotel.urls'
...
STATIC_URL = 'static/'
STATIC_ROOT = 'home/innohotel/booking/booking/'
